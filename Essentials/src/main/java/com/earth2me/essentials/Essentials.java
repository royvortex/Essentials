...
public class Essentials extends JavaPlugin implements net.ess3.api.IEssentials {
    ...
    private final transient Set<String> vanishedPlayers = ConcurrentHashMap.newKeySet();
    private final transient Map<String, IEssentialsCommand> commandMap = new ConcurrentHashMap<>();
    ...
    private static class EssentialsWorldListener implements Listener, Runnable {
        ...
        public void onWorldLoad(final WorldLoadEvent event) {
            PermissionsDefaults.registerDeathbackDefaultFor(event.getWorld());
        }
